...
public class ClientNotifications {
    ...
    public ClientNotifications(String message, String notification_id, String notification_receiver_user_id, String notification_sender_user_id, Long created_at, String rating_feedback) {
