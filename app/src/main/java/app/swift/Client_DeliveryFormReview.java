...
public class Client_DeliveryFormReview extends AppCompatActivity {
    ...
    private FirebaseAuth mAuth;
     ...
     TextView client_name,client_title,vehicle,pickup_location,dropoff_location,documentType,receiverName,receiverNumber,senderName,senderNumber,instructions,amount,distance,quantity;
     ImageView client_profileImg;
     String i_vehicle,i_pickup,i_dropoff,i_document,i_receiver,i_instructions,i_quantity,i_receiverNumber;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_client__delivery_form_review);

        MaterialDialog.Builder builder  = new MaterialDialog.Builder(Client_DeliveryFormReview.this)
                .content("Loading...")
        ...
        receiverName = (TextView) findViewById(R.id.deliveryReview_receiver1_txtVw);
        receiverNumber = (TextView) findViewById(R.id.deliveryReview_receiverNumber1_txtVw);
        senderName = (TextView) findViewById(R.id.deliveryReview_senderName1_txtVw);
        ...
        i_receiver = delivery_form.getStringExtra("receiverName");
        i_receiverNumber = delivery_form.getStringExtra("receiverNumber");
        ...
        receiverName.setText(i_receiver);
        receiverNumber.setText(i_receiverNumber);
        ...
        account_query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                senderNumber.setText("0" + user.getPhoneNumber().toString().substring(3));

                Transformation transformation = new RoundedTransformationBuilder()
                        .cornerRadiusDp(50)
                        .oval(false)
                        .build();
                Picasso.with(Client_DeliveryFormReview.this)
                        .load(image_profile)
                        .fit()
    ...
    public void post_delivery(View view){
        ...
        if(i_pickup.equals(null) || i_dropoff.equals(null)  || i_vehicle.equals(null) || i_document.equals(null) ||
                i_instructions.equals(null) || i_receiver.equals(null) || user.getUid().equals(null)){
            dialog.dismiss();
            new SweetAlertDialog(Client_DeliveryFormReview.this, SweetAlertDialog.ERROR_TYPE)
            ...
            postRef.child("delivery_type").setValue("deliver");
            ...
            postRef.child("sender_name").setValue(fullName);
            postRef.child("sender_number").setValue("0" + user.getPhoneNumber().toString().substring(3));
            postRef.child("receiver_name").setValue(i_receiver);
            postRef.child("receiver_number").setValue(i_receiverNumber);


            new SweetAlertDialog(Client_DeliveryFormReview.this, SweetAlertDialog.SUCCESS_TYPE)
                    ...
                    .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                        ...
                        public void onClick(SweetAlertDialog sweetAlertDialog) {
                            dialog.dismiss();
                            Intent intent = new Intent(Client_DeliveryFormReview.this,Client_Home.class);
    ...
    public void backToDeliveryForm(View view){
