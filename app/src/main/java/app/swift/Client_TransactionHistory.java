...
public class Client_TransactionHistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_client__transaction_history);
    ...
    public void getTransactions(){
        ...
        final Query transaction_query = transactionsRef.orderByChild("client_id").equalTo(user.getUid());
                ...
                if(dataSnapshot.exists()){
                    ...
                    final FirebaseRecyclerAdapter<TransactionHistory,TransactionHistoryViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<TransactionHistory, TransactionHistoryViewHolder>
                        ...
                        protected void populateViewHolder(final TransactionHistoryViewHolder viewHolder,final TransactionHistory model, int position) {
                            ...
                            Query accounts_query = accountRef.orderByChild("user_id").equalTo(model.getCourier_id());
                            ...
                            viewHolder.viewFulldetails.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    Intent intent = new Intent(Client_TransactionHistory.this, Client_TransactionHistory_fullDetails.class);
    ...
    public void backToClientNavMenu (View view){
