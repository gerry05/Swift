...
public class Courier_Feedbacks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_courier__feedbacks);
    ...
    public void getFeedbacks(){
        MaterialDialog.Builder builder  = new MaterialDialog.Builder(Courier_Feedbacks.this)
                .content("")
        ...
        final Query ratingsFeedback_query = ratings_feedbacksRef.orderByChild("rate_by_user_id").equalTo(user.getUid());
        ...
        ratingsFeedback_query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    dialog.dismiss();
                    final FirebaseRecyclerAdapter<Feedbacks, FeedbacksViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Feedbacks, FeedbacksViewHolder>
                            (Feedbacks.class, R.layout.feedbacks_cardview, FeedbacksViewHolder.class, ratingsFeedback_query) {
                        @Override
                        protected void populateViewHolder(final FeedbacksViewHolder viewHolder,final Feedbacks model, int position) {
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    if(dataSnapshot.exists()){
                                        ...
                                        Transformation transformation = new RoundedTransformationBuilder()
                                                ...
                                                .oval(false)
                                                .build();
                                        Picasso.with(Courier_Feedbacks.this)
