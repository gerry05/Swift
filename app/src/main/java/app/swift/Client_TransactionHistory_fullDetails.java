...
public class Client_TransactionHistory_fullDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_client__transaction_history_full_details);
        ...
        post_query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    ...
                    if(amount_db == null && distance_db == null && pickup_location_db == null && dropoff_location_db == null &&
                            document_db== null && instructions_db== null && receiver_db== null && sender_db== null && vehicle_db== null &&
                            client_id_db== null && posted_at_db== null && post_id_db == null && posted_at_db == null){
                    ...
                    accounts_query.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            Transformation transformation = new RoundedTransformationBuilder()
                                    ...
                                    .oval(false)
                                    .build();
                            Picasso.with(Client_TransactionHistory_fullDetails.this)
    ...
    public void backToClientHome(View view ){
