...
public class UsersFeedbacks extends AppCompatActivity {
    ...
    public void getFeedbacks(){
        MaterialDialog.Builder builder  = new MaterialDialog.Builder(UsersFeedbacks.this)
                .content("")
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    if(dataSnapshot.exists()){
                                        ...
                                        Transformation transformation = new RoundedTransformationBuilder()
                                                ...
                                                .oval(false)
                                                .build();
                                        Picasso.with(UsersFeedbacks.this)
