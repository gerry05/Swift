...
public class Courier_Requests_Posts_fullDetails extends AppCompatActivity {
    ...
    TextView name_txt,title_txt,amount_txt,distance_txt,vehicle_txt,pickup_txt,dropoff_txt,document_txt,receiver_txt,instructions_txt,date,quantity,sender_txt,senderNumber_txt,receiverNumber_txt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_courier__requests__posts_full_details);


        Intent courier_requests = getIntent();

        String post_id = courier_requests.getStringExtra("post_id");
        final String request_id = courier_requests.getStringExtra("request_id");
        ...
        cancel_request = (Button) findViewById(R.id.courier_view_post_cancel_btn);
        ...
        cancel_request.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new SweetAlertDialog(Courier_Requests_Posts_fullDetails.this,SweetAlertDialog.WARNING_TYPE)
                        ...
                        .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                            ...
                            public void onClick(SweetAlertDialog sweetAlertDialog) {
                                ...
                                requestRef.child(request_id).removeValue();
                                sweetAlertDialog.dismissWithAnimation();
                                Intent intent = new Intent(Courier_Requests_Posts_fullDetails.this, Courier_Requests.class);
                    ...
                    accounts_query.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            Transformation transformation = new RoundedTransformationBuilder()
                                    ...
                                    .oval(false)
                                    .build();
                            Picasso.with(Courier_Requests_Posts_fullDetails.this)
